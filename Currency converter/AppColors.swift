...
class AppColors: NSObject {
    static let amountColor = UIColor(hexString: "#2596B4")
    static let originalCurrencyColor = AppColors.amountColor
    static let destinationCurrencyColor = UIColor(hexString: "#2596B4")
}
